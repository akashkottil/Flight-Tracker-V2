...
struct FlightDetailDesignScreen: View {
    ...
    // Add these state variables after the existing @State properties
    @State private var scrollOffset: CGFloat = 0
    @State private var contentOffset: CGFloat = 0
    private let maxScrollLimit: CGFloat = 0.9 // 90% of screen height (10% gap from top)
        ...
        NavigationView {
            ScrollView(.vertical, showsIndicators: false) {
                ZStack() {
                    ...
                    VStack {
                                            Spacer(minLength: 300) // This will push the content down, adjust for half-screen
                                            flightDetailContent()
                                                .background(Color.white.opacity(0.9))  // Make it slightly transparent to see map
                                                .cornerRadius(20)
...
//    @State private var currentDetent: BottomSheetDetent = .partial
//
...
//        let content: Content
//
//    init(currentDetent: Binding<BottomSheetDetent>, dragOffset: Binding<CGFloat>, isDragging: Binding<Bool>, scrollEnabled: Binding<Bool>, @ViewBuilder content: () -> Content) {
...
//            let partialHeight = screenHeight * 0.4
//            let largeHeight = screenHeight * 0.9
//
//            let currentHeight = currentDetent == .partial ? partialHeight : largeHeight
//            let finalOffset = currentHeight + dragOffset
//
//            VStack(spacing: 0) {
//                // Drag Handle
...
//            .offset(y: screenHeight - finalOffset)
//            .animation(.easeIn(duration: 0.5), value: isDragging)
//
//            .gesture(
//                DragGesture()
//                    .onChanged { value in
...
//
//                        // Only handle meaningful drags
//                        if abs(translation) > 10 {
//                            isDragging = true
//                            scrollEnabled = false
//
//                            // Clamp dragOffset to prevent opposite movement
//                            if currentDetent == .partial && translation < 0 {
//                                // Expanding: only allow negative (upward) movement
//                                dragOffset = translation
//                            } else if currentDetent == .large && translation > 0 {
//                                // Collapsing: only allow positive (downward) movement
//                                dragOffset = translation
//                            } else if currentDetent == .partial && translation > 0 {
//                                // Prevent downward movement when already at bottom
//                                dragOffset = 0
//                            } else if currentDetent == .large && translation < 0 {
//                                // Prevent upward movement when already at top
//                                dragOffset = 0
//                            }
//                        }
//                    }
...
//                            let velocity = value.predictedEndTranslation.height / 1000
//
//                            let targetDetent: BottomSheetDetent
//
//                            if velocity > 0.5 || dragOffset > threshold {
//                                targetDetent = .partial
//                            } else if velocity < -0.5 || dragOffset < -threshold {
//                                targetDetent = .large
//                            } else {
...
//                                isDragging = false
//                                dragOffset = 0
//                                scrollEnabled = (targetDetent == .large)
//                            }
//                        }
//                    }
//            )
...
//
//extension View {
//    func ecornerRadius(_ radius: CGFloat, corners: UIRectCorner) -> some View {
//        clipShape(RoundedCorner(radius: radius, corners: corners))
//    }
//}
//
//struct eRoundedCorner: Shape {
